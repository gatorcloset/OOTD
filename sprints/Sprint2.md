# Completed Work
[Sprint 2 Demo](https://youtu.be/gdFZ1Ud1EQY)
## Frontend
...
- Login/Signup pages were created.
- The Sign Up page successfully calls the POST API function and creates a user.
- A User page was created to exhibit frontend integration with the GET API function.
...
- Checks that on the login page, if the user clicks the "sign up" button, they are redirected to /signup.
- Checks that the Sign Up page can create a POST request to the backend.
- Checks that the User page can create a GET request to the backend.
