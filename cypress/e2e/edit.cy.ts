describe('Edit and delete clothing item', () => {
  ...
  it('Edit clothing item image, name, and category', () => {
    ...
    cy.get('mat-grid-tile').get('#Bottoms').click()
    cy.get('mat-grid-tile').contains('Denim shorts').click()
    ...
    // Change category
    cy.get('#categories').contains('Top').click()
    
    cy.get('#save-button').click()
  })

  it('Check edited item and delete', () => {
